...
print("How to Play?")
print("")
print("In minigolf, click and drag the ball with your mouse to aim the ball. Once you release your hold, the ball will be launched in the opposite direction. The ball bounces on any white obstacles and if it is on top of the hole, then it goes in and you have finished the game! Click 'r' reset the course in the middle of your round.")
print("")
print("To improve your highscore, try to finish the course in the least amount of tries possible!")
print("")
print("******Randomization of the course is entirely up to your luck!")
...
def yeet(x, y): #tells where ball to go on release
  ...
  while(tempdistance < (distance/2)):
    ...
    ball.fd((distance/2)/155) #(distance/2)/60 for exact distance
    wn.update()
    tempdistance += ((distance/2)/155)
